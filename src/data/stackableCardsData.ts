...
export const marineCards: GenericCardData[] = [
  {
    ...
    imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/05/marine-yacht.png',
    icon: '🚢',
  ...
  },
  {
    ...
    imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/05/marine-pontoon.png',
    icon: '🛥️',
    badge: 'Marine Solutions',
    theme: 'marine',
    layout: 'reversed'
...
export const transportationCards: GenericCardData[] = [
  {
    ...
    imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/05/Ford-side-angle-1.png',
    icon: '🚛',
  ...
  },
  {
    ...
    imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/05/trailer-horse.png',
    icon: '🚛',
    badge: 'Transportation Solutions',
    theme: 'transportation',
    layout: 'reversed'
...
export const constructionCards: GenericCardData[] = [
  {
    ...
    imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/06/Forza-Built-House-Construction.jpg',
    icon: '🏗️',
    badge: 'Construction',
    theme: 'construction',
    layout: 'default'
  },
  {
    ...
    imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/06/Forza-Built-Construction-2-scaled.jpeg',
    icon: '🔬',
    badge: 'Construction',
    theme: 'construction',
    layout: 'reversed'
...
export const industrialCards: GenericCardData[] = [
  {
    ...
    imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/06/Forza-Built-General-Industries-2-2048x1365.jpeg',
    icon: '⚙️',
  ...
  },
  {
    ...
    imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/06/Industrial-Bonding-Adhesive.png',
    icon: '🏭',
    badge: 'Manufacturing',
    theme: 'industrial',
    layout: 'reversed'
  },
  {
    ...
    imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/06/Forza-Built-General-Industries-image-1-2048x1366.jpg',
    icon: '⚙️',
    badge: 'Industrial',
    theme: 'industrial',
    layout: 'reversed'
...
//     imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/06/Forza-Built-Foam-2-scaled.jpeg',
//     icon: '🧽',
...
//     imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/06/Forza-Built-Foam-Products-2-scaled.jpeg',
//     icon: '🧽',
//     badge: 'Foam Solutions',
//     theme: 'foam',
//     layout: 'reversed'
...
export const compositesCards: GenericCardData[] = [
  {
    ...
    imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/06/Forza-Composite-1-scaled.jpg',
    icon: '✈️',
    badge: 'Composites',
    theme: 'composites',
    layout: 'default'
  },
  {
    ...
    imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/elementor/thumbs/Forza-Built-Compsite-3-Cropped-que8zmnjfjma0xgvnoxmjmjxd8ng36vz9podec5mlc.png',
    icon: '🔬',
    badge: 'Composites',
    theme: 'composites',
    layout: 'reversed'
...
export const insulationCards: GenericCardData[] = [
  {
    ...
    imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/06/Forza-Built-Insulation-1-2048x1365.jpeg',
    icon: '🏡',
    badge: 'Insulation',
    theme: 'insulation',
    layout: 'default'
  },
  {
    ...
    imageUrl: 'https://www.forzabuilt.com/wp-content/uploads/2023/06/Forza-Built-Insulation-2-2048x1152.jpeg',
    icon: '🏡',
    badge: 'Insulation',
    theme: 'insulation',
    layout: 'reversed'
